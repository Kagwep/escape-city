...
export class ThirdPersonController {
    ...
    constructor(
        ...
        this.engine = _scene.getEngine() as BABYLON.Engine;
    ...
    private initPlayer(container: BABYLON.AssetContainer) {
        ...
        mesheRoot.scaling = new BABYLON.Vector3(12, 12, 12);
        player.position.y = 5;
        player.position.z = -5;
    ...
    private onMove() {
        ...
        if (this.isDead) {
            // If the player is dead, don't update the movement
            return;
        }
    ...
    private updateState = (): void => {
        ...
        if (
            ...
            if (!this.jumpState.jump && this.footRaycast.hasHit) {
                ...
                this.onAnimWeight(AnimationKey.Jump);
            }
        ...
        if (this.isDead){
            this.onAnimWeight(AnimationKey.Die);
        }
